...
export const ui = {
  'pt-br': {
    ...
    'marketing.activities.interview.title': 'Entrevistas simuladas',
    'marketing.activities.interview.desc':
    ...
    'marketing.values.inclusion.text':
      'Garantir que a educação tecnológica seja acessível a todos, independentemente de origem, renda ou localização. Somos um espaço seguro e acolhedor.',
    'marketing.values.collaboration.title': 'Colaboração',
    'marketing.values.collaboration.text':
      'Estudar junto é mais prazeroso e eficiente. Valorizamos o compartilhamento de conhecimento, discussões abertas e o apoio mútuo em projetos e estudos.',
    'marketing.values.quality.title': 'Qualidade de ensino',
    'marketing.values.quality.text':
      'Foco em mentoria e conteúdo que prepare de fato a próxima geração de profissionais digitais para o mercado de trabalho.',
    'marketing.community.title': 'Cultura e organização',
    'marketing.community.lead':
      'A comunidade se organiza para multiplicar impacto: núcleo pedagógico, guildas por área e iniciativas práticas dentro de cada uma.',
    ...
    'marketing.events.cta': 'Ver organização no GitHub',
    'marketing.channels.whatsapp.name': 'WhatsApp',
    'marketing.channels.whatsapp.desc':
    ...
    'about.hero.stats.education.label': 'Profissionalizante',
    'about.hero.stats.impact.value': 'Impacto',
    'about.hero.stats.impact.label': 'Social e comunitário',
    ...
    'joinUs.channels.title': 'Onde a comunidade vive',
    ...
    'joinUs.steps.s2.title': 'Escolha',
    'joinUs.steps.s2.desc':
    ...
    // ── Donations widget (SolidJS) ────────────────────────────────────────────
    'donations.widget.title': 'Escolha um valor',
    'donations.widget.subtitle': 'Sua doação faz toda a diferença',
    'donations.widget.suggestedLabel': 'Valores sugeridos',
    'donations.widget.customPlaceholder': 'Outro valor',
    'donations.widget.customAriaLabel': 'Valor da doação',
    'donations.widget.pixBadge': 'PIX',
    'donations.widget.copyButton': 'Copiar',
    'donations.widget.copiedButton': 'Copiado!',
    'donations.widget.copyAriaLabel': 'Copiar código PIX',
    'donations.widget.copiedAriaLabel': 'Copiado',
    'donations.widget.pixCodeAriaLabel': 'Código PIX copia e cola',
    'donations.widget.securityBadge': 'Pagamento seguro via PIX',
    'donations.widget.emptyState': 'Digite um valor válido para gerar o QR code',
    'donations.widget.errorGeneratingPix': 'Erro ao gerar código PIX.',
    'donations.widget.errorGeneratingQr': 'Erro ao gerar QR code.',
    ...
    'transparency.hero.eyebrow': 'Compromisso com a Transparência',
    'transparency.intro':
    ...
    'transparency.hero.stats.documents': 'Documentos',
    'transparency.hero.stats.members': 'Membros',
    ...
    'transparency.documents.empty': 'Nenhum documento disponível no momento.',
    'transparency.documents.back': 'Voltar para todos os documentos',
    'transparency.documents.available': 'Documento disponível para download',
