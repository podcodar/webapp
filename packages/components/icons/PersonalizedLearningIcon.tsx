...
export function PersonalizedLearningIcon(props: IconProps) {
		...
		<Icon fill="none" viewBox="0 0 180 180" {...props}>
			<g clipPath="url(#clip0)">
				<path
					...
					fill="#D3C0E6"
				/>
				<rect x="28.934" y="33.5" width="127" height="125" rx="7.5" stroke={lineColor} />
				<rect
					x="68.5"
					y="54.5"
					width="14"
				...
				<rect
					...
					height="15"
					rx="7.5"
					transform="rotate(-90 46.934 54.5)"
					stroke={lineColor}
				/>
				<rect x="50.934" y="62.5" width="4" height="89" rx="2" stroke={lineColor} />
				<rect x="45.934" y="73.5" width="14" height="3" rx="1.5" fill="#D3C0E5" stroke={lineColor} />
				<rect x="77.5" y="62.5" width="4" height="89" rx="2" stroke={lineColor} />
				<rect x="72.5" y="96.5" width="14" height="3" rx="1.5" fill="#D3C0E5" stroke={lineColor} />
				<rect x="103.5" y="62.5" width="4" height="89" rx="2" stroke={lineColor} />
				<rect x="98.5" y="81.5" width="14" height="3" rx="1.5" fill="#D3C0E5" stroke={lineColor} />
				<rect x="129.5" y="62.5" width="4" height="89" rx="2" stroke={lineColor} />
				<rect x="124.5" y="122.5" width="14" height="3" rx="1.5" fill="#D3C0E5" stroke={lineColor} />
			</g>
			<defs>
				<clipPath id="clip0">
